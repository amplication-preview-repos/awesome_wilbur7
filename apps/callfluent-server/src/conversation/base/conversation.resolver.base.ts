...
import { AiPhoneAgent } from "../../aiPhoneAgent/base/AiPhoneAgent";
...
export class ConversationResolverBase {
  ...
  async createConversation(
    ...
    return await this.service.createConversation({
      ...
      data: {
        ...
        aiPhoneAgent: args.data.aiPhoneAgent
          ? {
              connect: args.data.aiPhoneAgent,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => AiPhoneAgent, {
    nullable: true,
    name: "aiPhoneAgent",
  })
  async getAiPhoneAgent(
    @graphql.Parent() parent: Conversation
  ): Promise<AiPhoneAgent | null> {
    const result = await this.service.getAiPhoneAgent(parent.id);
  ...
  async BookAppointment(
    ...
    return this.service.BookAppointment(args);
  }
}
