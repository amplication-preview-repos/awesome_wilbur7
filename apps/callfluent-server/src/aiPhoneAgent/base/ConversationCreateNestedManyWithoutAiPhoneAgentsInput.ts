...
@InputType()
class ConversationCreateNestedManyWithoutAiPhoneAgentsInput {
...
export { ConversationCreateNestedManyWithoutAiPhoneAgentsInput as ConversationCreateNestedManyWithoutAiPhoneAgentsInput };
